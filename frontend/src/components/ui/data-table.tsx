...
interface DataTableProps<T> {
  ...
  onSearchChange?: (value: string) => void; // Make optional
...
export function DataTable<T>({
  ...
  className = "",
  useCard = true // Default to true for backward compatibility
}: DataTableProps<T>) {
  const content = (
    <>
      {/* Filter and Actions */}
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        {/* Search - Only show if searchTerm is provided */}
